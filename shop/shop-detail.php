...
<body>
  ...
  <div class="shop-detail-box-main">
    <div class="container">
      <div class="row">
        <form style="display: contents;" action="cart.php" method="POST">
            ...
            <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
              ...
              <ol class="carousel-indicators">
                <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                  <img class="d-block w-100 img-fluid" src="../admin/img/Coffee/<?= $tbl_product['productImage'] ?>" alt="" />
                </li>
          ...
          <div class="col-xl-7 col-lg-7 col-md-6">
            <div class="single-product-details">
              ...
              <h5> <del>$ 60.00</del> <?= number_format($tbl_product["productPrice"], 0, '', ',') ?> VNĐ</h5>
              ...
              <ul>
                <li>
                  <div class="form-group quantity-box">
                    ...
                    <input class="form-control" value="0" min="0" max="30" type="number" name="productQuantity">
                  </div>
                </li>
              </ul>
